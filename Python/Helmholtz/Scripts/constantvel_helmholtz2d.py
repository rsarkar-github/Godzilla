...
vel.set_constant_velocity(vel=2.5)
...
# np.savez("Python/Helmholtz/Data/constant_low_vel_sol.npz", x)
# x = np.load("Python/Helmholtz/Data/constant_low_vel_sol.npz")["arr_0"]

np.savez("Python/Helmholtz/Data/constant_high_vel_sol.npz", x)
x = np.load("Python/Helmholtz/Data/constant_high_vel_sol.npz")["arr_0"]
