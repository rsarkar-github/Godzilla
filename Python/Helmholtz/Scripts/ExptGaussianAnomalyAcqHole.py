...
inverted_model, inversion_metrics = tfwilsq.perform_lsm_cg(
    ...
    lsm_image_file=Common.filepath_base + "Fig/lsm-inverted-image-anomaly0.3-maxoff2.0-hole1.0-eps0.2",
    lsm_image_data_file=Common.filepath_base + "Data/lsm-inverted-image-anomaly0.3-maxoff2.0-hole1.0-eps0.2",
    save_lsm_adjoint_image=True,
    save_lsm_adjoint_allimages=False,
    lsm_adjoint_image_file=Common.filepath_base + "Fig/lsm-adjoint-image-anomaly0.3-maxoff2.0-hole1.0",
    lsm_adjoint_image_data_file=Common.filepath_base + "Data/lsm-adjoint-image-anomaly0.3-maxoff2.0-hole1.0"
)
