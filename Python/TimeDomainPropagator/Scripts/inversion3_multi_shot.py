...
if os.path.exists("Python/TimeDomainPropagator/Data/inversion3_multi_shot.npz"):
    inverted_model = np.load("Python/TimeDomainPropagator/Data/inversion3_multi_shot.npz")["arr_0"]
else:
...
np.savez("Python/TimeDomainPropagator/Data/inversion3_multi_shot.npz", inverted_model, metrics)
