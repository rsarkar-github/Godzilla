...
plt.show()
fig.savefig("D:/Research/Freq-Domain/Godzilla/Python/IntegralEquation/Fig/vels.pdf", bbox_inches='tight', pad_inches=0)
...
plt.show()
fig.savefig("D:/Research/Freq-Domain/Godzilla/Python/IntegralEquation/Fig/chi.pdf", bbox_inches='tight', pad_inches=0)
