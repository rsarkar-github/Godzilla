...
scale = 1e-5
fig = plt.figure()
# np.savez(file="G:/Research/Freq-Domain/Godzilla/Python/IntegralEquation/Data/linvel_gaussian_sol_test1_alpha0.01_rhs.npz", args=rhs)
...
# np.savez("G:/Research/Freq-Domain/Godzilla/Python/IntegralEquation/Data/linvel_gaussian_sol_test1_alpha0.01.npz", x)
# fig = plt.figure()
