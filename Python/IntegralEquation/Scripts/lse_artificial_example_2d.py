...
def create_pert_fields(mode, plot=False, fig_filename="fig.pdf"):
    ...
    if plot:
        ...
        ax.grid(True)
        ax.set_title("Background Velocity", fontname="Times New Roman", fontsize=20)
        ax.set_xticks(xticks)
        ax.set_xticklabels(xticklabels, fontname="Times New Roman", fontsize=20)
        ax.set_yticks(yticks)
        ax.set_yticklabels(yticklabels, fontname="Times New Roman", fontsize=20)
        ax.set_xlabel(r"$x$  [km]", fontname="Times New Roman", fontsize=20)
        ax.set_ylabel(r"$z$  [km]", fontname="Times New Roman", fontsize=20)

        divider = make_axes_locatable(ax)
        cax = divider.append_axes("right", size="5%", pad=0.05)
        cbar = plt.colorbar(im0, cax=cax)
        cbar.set_label("[km/s]", rotation=270, fontname="Times New Roman", fontsize=20, labelpad=10)
        ...
        ax.grid(True)
        ax.set_title("Total Velocity", fontname="Times New Roman", fontsize=20)
        ax.set_xticks(xticks)
        ax.set_xticklabels(xticklabels, fontname="Times New Roman", fontsize=20)
        ax.set_xlabel(r"$x$  [km]", fontname="Times New Roman", fontsize=20)
        ...
        ax.grid(True)
        ax.set_title("Perturbation", fontname="Times New Roman", fontsize=20)
        ax.set_xticks(xticks)
        ax.set_xticklabels(xticklabels, fontname="Times New Roman", fontsize=20)
        ax.set_xlabel(r"$x$  [km]", fontname="Times New Roman", fontsize=20)
...
# scale_sol = np.max(np.abs(np.real(sol))) / 2
scale_sol = 2e-4
plot_sol(np.reshape(sol, newshape=(nz, n)), "sol_lse.pdf", "", scale=scale_sol)
