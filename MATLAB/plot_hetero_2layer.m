...
file = fopen('real_hetero_2layer.bin');
real = fread(file, [N1 N2], 'double');
fclose(file);

file = fopen('imag_hetero_2layer.bin');
...
print(h,'-depsc2','-painters','real-hetero-2layer.eps')
close(h)
...
set(gca,'YTick',marks)
set(gca,'YTickLabel',labels)
print(h,'-depsc2','-painters','imag-hetero-2layer.eps')
close(h)
