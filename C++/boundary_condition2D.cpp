...
namespace Godzilla {
	// Constructors
	BoundaryCondition2D::BoundaryCondition2D(std::string bc_face1, std::string bc_face2, std::string bc_face3, std::string bc_face4) {
		_bc_face1 = bc_face1;
		_bc_face2 = bc_face2;
		_bc_face3 = bc_face3;
		_bc_face4 = bc_face4;
	...
	BoundaryCondition2D::BoundaryCondition2D(std::string bc_face1, size_t pmlcells_face1, std::string bc_face2, size_t pmlcells_face2,
											 std::string bc_face3, size_t pmlcells_face3, std::string bc_face4, size_t pmlcells_face4) {
		_bc_face1 = bc_face1;
		_bc_face2 = bc_face2;
		_bc_face3 = bc_face3;
		_bc_face4 = bc_face4;
		...
		_pmlcells_face3 = ((bc_face3 == "PML") && (pmlcells_face3 > 0)) ? pmlcells_face3 : Godzilla::PML_CELLS_DEFAULT;
		_pmlcells_face4 = ((bc_face4 == "PML") && (pmlcells_face4 > 0)) ? pmlcells_face4 : Godzilla::PML_CELLS_DEFAULT;
	}
