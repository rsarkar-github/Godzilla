...
int main() {
	...
	wavemod2d::EasyIO io;
	io.write_binary("D:/Research/Freq-Domain/Godzilla/test/real_homog.bin", solution2Dreal);
	io.write_binary("D:/Research/Freq-Domain/Godzilla/test/imag_homog.bin", solution2Dimag);
